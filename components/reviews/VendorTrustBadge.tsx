  ...
  return (
    <>
      <button
        ...
        onMouseEnter={(e) => {
          if (showModalOnClick) {
            (e.currentTarget as HTMLButtonElement).style.background = 'rgba(234, 179, 8, 0.22)';
            (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 12px rgba(234, 179, 8, 0.25)';
          }
        }}
        onMouseLeave={(e) => {
          if (showModalOnClick) {
