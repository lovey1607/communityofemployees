    ...
    <svg viewBox="0 0 80 80" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="sportsGold" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#137A43" />
          <stop offset="40%" stopColor="#1E9E5A" />
          <stop offset="100%" stopColor="#12854A" />
        </linearGradient>
        <radialGradient id="trophyCup" cx="35%" cy="30%" r="70%">
          <stop offset="0%" stopColor="#fef08a" />
          <stop offset="35%" stopColor="#B23A7A" />
          <stop offset="85%" stopColor="#b45309" />
          <stop offset="100%" stopColor="#78350f" />
        </radialGradient>
        <filter id="sportsGlow" x="-20%" y="-20%" width="140%" height="140%">
          <feDropShadow dx="0" dy="6" stdDeviation="6" floodColor="#1E9E5A" floodOpacity="0.4" />
        </filter>
      </defs>
      <g filter="url(#sportsGlow)">
        ...
        />
        {/* Stem & Solid Base */}
        <rect x="37" y="54" width="6" height="10" fill="#8E2C61" />
        <rect x="26" y="64" width="28" height="8" rx="3" fill="#1D1A17" stroke="#8E2C61" strokeWidth="1.5" />
    ...
    <svg viewBox="0 0 80 80" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="partyGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="#D9541C" />
        </linearGradient>
        <linearGradient id="glassStem" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#ffffff" />
          <stop offset="100%" stopColor="#EBDFCC" />
        </linearGradient>
        <filter id="foodGlow" x="-20%" y="-20%" width="140%" height="140%">
          <feDropShadow dx="0" dy="6" stdDeviation="6" floodColor="#FF6B2C" floodOpacity="0.4" />
        </filter>
      </defs>
      <g filter="url(#foodGlow)">
        ...
        <path d="M40 12V18M40 26V32M34 22H30M50 22H46" stroke="#F9DDEB" strokeWidth="1.5" strokeLinecap="round" />
      </g>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 80 80" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="jetGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="50%" stopColor="#2E6BFF" />
          <stop offset="100%" stopColor="#1E4FCC" />
        </linearGradient>
        <filter id="tripsGlow" x="-20%" y="-20%" width="140%" height="140%">
          <feDropShadow dx="0" dy="6" stdDeviation="6" floodColor="#2E6BFF" floodOpacity="0.45" />
        </filter>
      </defs>
      <g filter="url(#tripsGlow)">
        ...
        <ellipse cx="40" cy="46" rx="32" ry="12" stroke="rgba(109, 151, 255, 0.4)" strokeWidth="1.5" strokeDasharray="3 4" />
      </g>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 80 80" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="goldBox" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#fef08a" />
          <stop offset="40%" stopColor="#B23A7A" />
        ...
        <filter id="giftsGlow" x="-20%" y="-20%" width="140%" height="140%">
          <feDropShadow dx="0" dy="6" stdDeviation="6" floodColor="#B23A7A" floodOpacity="0.4" />
        </filter>
      </defs>
      <g filter="url(#giftsGlow)">
        ...
        <rect x="14" y="24" width="52" height="12" rx="4" fill="#8E2C61" stroke="#ffffff" strokeWidth="1.5" />
    ...
    <svg viewBox="0 0 80 80" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="blazerGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="50%" stopColor="#1D1A17" />
          <stop offset="100%" stopColor="#1D1A17" />
        </linearGradient>
        <linearGradient id="goldButton" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#fef08a" />
          <stop offset="100%" stopColor="#8E2C61" />
        </linearGradient>
        <filter id="dressGlow" x="-20%" y="-20%" width="140%" height="140%">
          <feDropShadow dx="0" dy="6" stdDeviation="6" floodColor="#7A7169" floodOpacity="0.4" />
        </filter>
      </defs>
      <g filter="url(#dressGlow)">
        ...
        />
        {/* Lapels */}
        <path d="M34 24L40 44L46 24" stroke="#EBDFCC" strokeWidth="2" strokeLinecap="round" />
