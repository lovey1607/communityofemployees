...
await page.getByRole('button', { name: /Post what you need/i }).click();
...
await emp.getByRole('button', { name: /Post what you need/i }).click();
...
await vendor.getByRole('button', { name: /Post what you need/i }).click();
